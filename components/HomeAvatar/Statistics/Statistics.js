  ...
  return (
    <div className={classes.root}>
      <div className={classes.background}>
        ...
        <Box px={isTablet ? 3 : 0}>
          <Title text={t('avatar.stats_title')} align="center" />
        </Box>
        <Expertise />
        <Grid className={classes.wrapper} container justifyContent="center" spacing={6}>
          {!isTablet && (
            <Grid item lg={4} md={4} xs={12}>
              <Box className={classes.avatar}>
                <img src={imgAPI.profile[2]} alt="avatar full" />
              </Box>
            </Grid>
          )}
