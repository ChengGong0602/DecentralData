                  ...
                  <div className={classes.properties}>
                    <div className={classes.desc}>
                      ...
                      <div className={classes.btnArea}>
                        {btnPrimary && <Button size="large" variant="contained" href={btnPrimary.href} color={theme.palette.mode === 'dark' ? 'primaryLight' : 'primary'}>{btnPrimary.text}</Button>}
                        {btnSecondary && <Button size="large" variant="outlined" href={btnSecondary.href} color={theme.palette.mode === 'dark' ? 'white' : 'black'}>{btnSecondary.text}</Button>}
                      </div>
                    </div>
