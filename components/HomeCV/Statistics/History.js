        ...
        <ul>
          <li>
            ...
            >
              <div className={classes.list}>
                <figure>
                  <img src={imgAPI.logos[1]} alt="history" />
                </figure>
                <div>
          ...
          <li>
            ...
            >
              <div className={classes.list}>
                <figure>
                  <img src={imgAPI.logos[13]} alt="history" />
                </figure>
                <div>
          ...
          <li>
            ...
            >
              <div className={classes.list}>
                <figure>
                  <img src={imgAPI.logos[61]} alt="history" />
                </figure>
                <div>
          ...
          <li>
            ...
            >
              <div className={classes.list}>
                <figure>
                  <img src={imgAPI.logos[10]} alt="history" />
                </figure>
                <div>
                  <Typography variant="h3" gutterBottom className={text.subtitle2}>UI/UX Designer</Typography>
          ...
          <li>
            ...
            >
              <div className={classes.list}>
                <figure>
                  <img src={imgAPI.logos[12]} alt="history" />
                </figure>
                <div>
                  <Typography variant="h3" gutterBottom className={text.subtitle2}>UI/UX Designer</Typography>
                  <Typography gutterBottom>at First Company</Typography>
          ...
          <li>
            ...
            >
              <div className={classes.list}>
                <figure>
                  <img src={imgAPI.logos[16]} alt="history" />
                </figure>
                <div>
                  <Typography variant="h3" gutterBottom className={text.subtitle2}>UI/UX Designer</Typography>
                  <Typography gutterBottom>at First Company</Typography>
