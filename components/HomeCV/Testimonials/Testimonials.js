      ...
      <Container>
        <Grid container>
          <Grid item md={12} xs={12}>
            <Title align={isDesktop ? 'left' : 'center'} text={t('profile.testi_title')} />
          </Grid>
        </Grid>
      </Container>
            ...
            <SliderArt fade={fade}>
              <ScrollAnimation animateOnce animateIn="fadeInLeftShort" offset={-60} delay={300} duration={0.5}>
                <div className={classes.avatarArt}>
                  <Avatar
                    sx={{
 top: 20, left: 440, width: 64, height: 64
}}
                    className={classes.avatar}
                    src={imgAPI.avatar[30]}
                    alt="decoration"
                  />
                  <Avatar
                    sx={{
 top: 120, left: 280, width: 48, height: 48
}}
                    className={classes.avatar}
                    src={imgAPI.avatar[11]}
                    alt="decoration"
                  />
                  <Avatar
                    sx={{
 top: 150, left: 440, width: 32, height: 32
}}
                    className={classes.avatar}
                    src={imgAPI.avatar[33]}
                    alt="decoration"
                  />
                  <Avatar
                    sx={{
 top: 280, left: 300, width: 64, height: 64
}}
                    className={classes.avatar}
                    src={imgAPI.avatar[28]}
                    alt="decoration"
                  />
                  <Avatar
                    sx={{
 top: 260, left: 500, width: 64, height: 64
}}
                    className={classes.avatar}
                    src={imgAPI.avatar[32]}
                    alt="decoration"
                  />
                </div>
              </ScrollAnimation>
