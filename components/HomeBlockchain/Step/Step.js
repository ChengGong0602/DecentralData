...
function Step() {
  ...
  return (
    <Container>
      <ParallaxTitle
        bgTitle={t('blockchain.discover_bgtitle')}
        mainTitle={t('blockchain.discover_title')}
        color="doubleMain"
      />
      <Grid container className={classes.step} spacing={isDesktop ? 6 : 0}>
          ...
          <div className={classes.item}>
            <div className={classes.icon}>
              <div className={classes.center}>
                <Icons3d icon="mdi-bitcoin" color="primaryDouble" />
              </div>
              <div className={classes.left}>
                <Icons3d icon="mdi-arrow-top-right-bold-box" color="accent" />
              </div>
            ...
            <div className={cx(classes.glow, classes.primary)}>
              <Typography variant="h6" className={text.subtitle2}>
                {t('blockchain.step_title1')}
              </Typography>
              <Typography component="p" className={text.paragraph}>
                {t('blockchain.step_desc1')}
              </Typography>
            </div>
        ...
        <Grid item sm={4}>
          <div className={classes.item}>
            <div className={classes.icon}>
              <div className={classes.center}>
                <Icons3d icon="mdi-wallet" color="secondaryDouble" />
              </div>
              <div className={classes.left}>
                <Icons3d icon="mdi-bitcoin" color="primary" />
              </div>
              <div className={classes.right}>
                <Icons3d icon="mdi-image" color="accent" />
              </div>
            </div>
            <div className={cx(classes.glow, classes.secondary)}>
              <Typography variant="h6" className={text.subtitle2}>
                {t('blockchain.step_title2')}
              </Typography>
              <Typography component="p" className={text.paragraph}>
                {t('blockchain.step_desc2')}
              </Typography>
            </div>
        ...
        <Grid item sm={4}>
          <div className={classes.item}>
            ...
            <div className={cx(classes.glow, classes.accent)}>
              <Typography variant="h6" className={text.subtitle2}>
                {t('blockchain.step_title3')}
              </Typography>
              <Typography component="p" className={text.paragraph}>
                {t('blockchain.step_desc3')}
              </Typography>
            </div>
          </div>
        </Grid>
