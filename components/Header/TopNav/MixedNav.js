  ...
  return (
    ...
    >
      {menuPrimary.map(item => (
        <li key={item.id}>
          {singleNav ? (
            <Button component={LinkBtn} offset={() => 100} href={`#${item.id}`}>
                      ...
                      <Grid container spacing={4}>
                        <Grid item sm={5}>
                          ...
                          <Grid container spacing={1}>
                            <Grid item sm={4}>
                              <ButtonBase href={link.home} className={classes.thumbLink}>
                                <figure className={classes.thumbMenu}>
                                  <img src={imgAPI.ui[6]} alt="thumbnail" />
                                </figure>
                                Machine Learning
                              </ButtonBase>
                              <ButtonBase href={link.fintech} className={classes.thumbLink}>
                                <figure className={classes.thumbMenu}>
                                  <img src={imgAPI.ui[8]} alt="thumbnail" />
                                </figure>
                                AI Trading Bot
                              </ButtonBase>
                              <ButtonBase href={link.nft} className={classes.thumbLink}>
                                <figure className={classes.thumbMenu}>
                            ...
                            <Grid item sm={4}>
                              <ButtonBase href={link.blockchain} className={classes.thumbLink}>
                                <figure className={classes.thumbMenu}>
                                  <img src={imgAPI.ui[7]} alt="thumbnail" />
                                </figure>
                                Blockchain
                              </ButtonBase>
                              <ButtonBase href={link.avatar} className={classes.thumbLink}>
                                <figure className={classes.thumbMenu}>
                                  <img src={imgAPI.ui[10]} alt="thumbnail" />
                                </figure>
                                Avatar
                              </ButtonBase>
                              <ButtonBase href={link.nft2} className={classes.thumbLink}>
                                <figure className={classes.thumbMenu}>
                            ...
                            <Grid item sm={4}>
                              <ButtonBase href={link.wallet} className={classes.thumbLink}>
                                <figure className={classes.thumbMenu}>
                                  <img src={imgAPI.ui[9]} alt="thumbnail" />
                                </figure>
                                Crypto Wallet
                              </ButtonBase>
                              <ButtonBase href={link.cv} className={classes.thumbLink}>
                                <figure className={classes.thumbMenu}>
