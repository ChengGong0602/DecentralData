...
function ChartPrice() {
  ...
  return (
    <div className={classes.root}>
      <ParallaxLeft />
      <Container>
        <Grid container justifyContent={isDesktop ? 'flex-start' : 'center'} spacing={6}>
          <Grid item md={5} xs={12}>
            <Title dark text={t('fintech.chart_title')} />
          ...
          <Grid item md={7} xs={12}>
            ...
            <Box px={2}>
              <Button className={classes.btn} href={link.register} size="large" color="secondary">
                {t('btn_get')}
                <ArrowForwardIcon />
              </Button>
            </Box>
