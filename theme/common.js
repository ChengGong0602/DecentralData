...
export const useSpacing = makeStyles({ uniqId: 'spacing' })(theme => ({
  ...
  primaryIcon: {
    ...
    borderRadius: '50%',
    position: 'relative',
    backgroundImage: `linear-gradient(180deg, ${theme.palette.accent.light} 0%, ${theme.palette.primary.light} 100%)`,
    '& > div': {
      fontSize: 50,
      left: -50,
      top: 40,
  ...
  secondaryIcon: {
    ...
    borderRadius: '50%',
    position: 'relative',
    backgroundImage: `linear-gradient(180deg, ${theme.palette.secondary.main} 0%, ${theme.palette.primary.light} 100%)`,
    '& > div': {
      fontSize: 40,
      left: -20,
      top: -10,
  ...
  accentIcon: {
    ...
    borderRadius: '50%',
    position: 'relative',
    backgroundImage: `linear-gradient(180deg, ${theme.palette.secondary.light} 0%, ${theme.palette.accent.light} 100%)`,
    '& > div': {
      fontSize: 40,
      left: -20,
      top: -20,
